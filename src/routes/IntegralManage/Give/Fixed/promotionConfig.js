...
class PromotionConfigPage extends React.Component {
  constructor(props) {
    super(props);
    const {
      system: { query },
    ...
    if (isDateLoading) {
      return (
        <div className="p-approve-set-wrap">
          <Card title="彩蛋發放項詳情配置" bordered={false}>
      ...
      <div className="p-approve-set-wrap">
        <Card title="彩蛋發放項詳情配置" bordered={false}>
          <div className="approve-set-content">
            ...
            <div className="list-item">
              <p className="item-title">發分規則</p>
              <div className="item-value-wrap">
                <span className="text">每觸發 </span>
                <InputToolTipCom
                  disabled={isDisabledEidt}
                  value={
                    entryInfo.offer_rules.length > 0 &&
                    entryInfo.offer_rules[0].rule.length > 0 &&
                    entryInfo.offer_rules[0].rule[0].times
                  }
                ...
                <InputToolTipCom
                  ...
                  value={
                    entryInfo.offer_rules.length > 0 &&
                    entryInfo.offer_rules[0].change_value.length > 0 &&
                    entryInfo.offer_rules[0].change_value[0]
                  }
                  max={INPUT_NUMBER_MAX}
                  min={1}
                  step={1}
            ...
            <div className="list-item">
              ...
              <div className="item-value-wrap">
                <div>
                  ...
                  <Select
                    disabled={
                      entryInfo.offer_rules[0].top.dimenssion === 'no_top' ||
                      isDisabledEidt
                    }
                    ...
                    value={
                      entryInfo.offer_rules[0].top.dimenssion === 'no_top'
                        ? ''
                        : entryInfo.offer_rules[0].top.dimenssion
                    }
                  ...
                  <InputToolTipCom
                    ...
                    value={entryInfo.offer_rules[0].top.most}
                    formatter={(value) =>
                      `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')
                    }
                    parser={(value) => value.replace(/(,*)/g, '')}
            ...
            <div className="list-item">
              ...
              <div style={{ marginTop: -15 }}>
                <Checkbox
                  disabled={isDisabledEidt}
                  checked={entryInfo.offer_rules[0].top.dimenssion === 'no_top'}
            ...
            <div className="list-item">
              ...
              <div style={{ marginTop: -15 }} className="tips">
                * 超過使用有效時間,則系統賬戶會回收未使用的積分, 完成成本核算
              </div>
            </div>
            {/* <div className="list-item">
